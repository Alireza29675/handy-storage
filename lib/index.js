    ...
    _createClass(HandyStorage, [{
        ...
        value: function setState() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if ((typeof changes === 'undefined' ? 'undefined' : _typeof(changes)) !== 'object') {
                    return reject('Given parameter in .setState() must be an object, you gave a ' + (typeof changes === 'undefined' ? 'undefined' : _typeof(changes)));
                }

                // assigning changes to current state
                Object.assign(_this.state, changes);
        ...
        value: function save() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (_this2.savingInProgress) return reject();

                // Save it if saving was not in progress
                _this2.savingInProgress = true;
